...
import {
  ...
  getProjectPlanByIdAndMonthSchema,
} from "../../../../../../forms/projectPlan";
import { getProjectPlanByIdAndMonth } from "../../../../../../services/projectPlan";
...
export default withExceptionHandler(async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  if (req.method === "GET") {
    ...
    const params = await validateInput<GetProjectPlanByIdAndMonthApiForm>(getProjectPlanByIdAndMonthSchema, req);
    const result = await getProjectPlanByIdAndMonth(token, params);
